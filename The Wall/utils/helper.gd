...
static func shorten_distance(base_vector: Vector2, vector_to_move: Vector2, distance: int):
	vector_to_move -= base_vector
	vector_to_move.clamped(distance)
	return vector_to_move + base_vector
